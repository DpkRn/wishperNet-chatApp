          ...
          <div className="flex gap-5 items-center justify-start text-neutral-300">
           ...
           ( <Avatar className="h-10 w-10 rounded-full overflow-hidden">
              {contact.image ? (
                ...
                <div
                  className={`uppercase h-10 w-10  text-lg border-[1px] flex items-center justify-center rounded-full ${selectedChatData&&selectedChatData._id===contact._id?"bg-[#ffffff22] border border-white/70":getColor(
                    contact.color) }`}
                >
                  {contact.firstName
