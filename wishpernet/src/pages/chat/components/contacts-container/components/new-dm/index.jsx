      ...
      <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModel}>
        <DialogContent className="bg-[#181920] border-none text-white h-[400px] w-[400px] flex flex-col">
          ...
          {searchedContacts.length <= 0 && (
            <div className="flex-1  md:flex flex-col justify-center mt-5 items-center  duration-1000 transition-all">
              <Lottie
              ...
              />
              <div className="text-opacity-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-4xl text-3xl duration-300 transition-all text-center">
